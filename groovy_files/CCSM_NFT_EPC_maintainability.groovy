pipelineJob('CCSM_NFT_EPC_maintainability') {
    description('HSS-EPC Non Functional Maintainability Test')
    ...
    definition {
        cpsScm {
            scm {
                ...
                lightweight(false)
                scriptPath('jenkinsFiles/Jenkinsfile.EPC_maintainability')
            }
        }
    }
}
