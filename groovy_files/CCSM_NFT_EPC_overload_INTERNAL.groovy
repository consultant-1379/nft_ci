pipelineJob('CCSM_NFT_EPC_overload_INTERNAL') {
    description('HSS-EPC Internal Non Functional Overload Test')
    ...
    definition {
        cpsScm {
            scm {
                ...
                lightweight(false)
                scriptPath('jenkinsFiles/Jenkinsfile.EPC_overloadInternal')
            }
        }
    }
}
