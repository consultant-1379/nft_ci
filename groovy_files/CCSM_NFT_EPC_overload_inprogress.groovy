pipelineJob('CCSM_NFT_EPC_overload_inprogress') {
    description('HSS-EPC Non Functional InProgress Overload Test')
    ...
    definition {
        cpsScm {
            scm {
                ...
                lightweight(false)
                scriptPath('jenkinsFiles/Jenkinsfile.EPC_overloadInProgress')
            }
        }
    }
}
