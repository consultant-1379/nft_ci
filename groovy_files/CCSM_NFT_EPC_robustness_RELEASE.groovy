pipelineJob('CCSM_NFT_EPC_robustness_RELEASE') {
    description('HSS-EPC release Non Functional Robustness Test')
    ...
    definition {
        cpsScm {
            scm {
                ...
                lightweight(false)
                scriptPath('jenkinsFiles/Jenkinsfile.EPC_robustness')
            }
        }
    }
}
