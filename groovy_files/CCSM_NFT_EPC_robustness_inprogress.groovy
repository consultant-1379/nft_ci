pipelineJob('CCSM_NFT_EPC_robustness_inprogress') {
    description('HSS-EPC in progress Non Functional Robustness Test')
    ...
    definition {
        cpsScm {
            scm {
                ...
                lightweight(false)
                scriptPath('jenkinsFiles/Jenkinsfile.EPC_robInProgress')
            }
        }
    }
}
