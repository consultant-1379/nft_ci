pipelineJob('CCSM_NFT_IMS_EPC_INTERNAL') {
    description('HSS-IMS+EPC internal Non Functional Test parent job')
    ...
    definition {
        cpsScm {
            scm {
                ...
                lightweight(false)
                scriptPath('jenkinsFiles/Jenkinsfile.IMS_EPC_INTERNAL')
            }
        }
    }
}
