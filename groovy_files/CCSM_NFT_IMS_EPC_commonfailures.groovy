pipelineJob('CCSM_NFT_IMS_EPC_commonfailures') {
    description('HSS-IMS+EPC Non Functional CommonFailures Test')
    ...
    definition {
        cpsScm {
            scm {
                ...
                lightweight(false)
                scriptPath('jenkinsFiles/Jenkinsfile.IMS_EPC_commonfailures')
            }
        }
    }
}
