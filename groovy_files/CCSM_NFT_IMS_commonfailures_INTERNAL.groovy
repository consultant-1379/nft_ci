pipelineJob('CCSM_NFT_IMS_commonfailures_INTERNAL') {
    description('HSS-IMS internal Non Functional CommonFailures Test')
    ...
    definition {
        cpsScm {
            scm {
                ...
                lightweight(false)
                scriptPath('jenkinsFiles/Jenkinsfile.IMS_commonfailures')
            }
        }
    }
}
