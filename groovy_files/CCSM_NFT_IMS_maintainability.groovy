pipelineJob('CCSM_NFT_IMS_maintainability') {
    description('HSS-IMS Non Functional Maintainability Test')
    ...
    definition {
        cpsScm {
            scm {
                ...
                lightweight(false)
                scriptPath('jenkinsFiles/Jenkinsfile.IMS_maintainability')
            }
        }
    }
}
