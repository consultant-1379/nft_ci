pipelineJob('CCSM_NFT_IMS_overload_INTERNAL') {
    description('HSS-IMS Internal Non Functional Overload Test')
    ...
    definition {
        cpsScm {
            scm {
                ...
                lightweight(false)
                scriptPath('jenkinsFiles/Jenkinsfile.IMS_overloadInternal')
            }
        }
    }
}
