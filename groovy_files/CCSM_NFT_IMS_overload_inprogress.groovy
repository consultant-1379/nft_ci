pipelineJob('CCSM_NFT_IMS_overload_inprogress') {
    description('HSS-IMS Non Functional InProgress Overload Test')
    ...
    parameters {
        ...
        booleanParam(ccsm_default_params['pre_post']['name'], ccsm_default_params['pre_post']['value'].toBoolean(), ccsm_default_params['pre_post']['help'])
    ...
    definition {
        cpsScm {
            scm {
                ...
                lightweight(false)
                scriptPath('jenkinsFiles/Jenkinsfile.IMS_overloadInProgress')
            }
        }
    }
}
