pipelineJob('CCSM_NFT_IMS_podsfaults_INTERNAL') {
    description('HSS-IMS internal Non Functional PodsFaults Test')
    ...
    definition {
        cpsScm {
            scm {
                ...
                lightweight(false)
                scriptPath('jenkinsFiles/Jenkinsfile.IMS_podsfaults')
            }
        }
    }
}
