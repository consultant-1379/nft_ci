pipelineJob('CCSM_NFT_IMS_robustness_INTERNAL') {
    description('HSS-IMS internal Non Functional Robustness Test')
    ...
    definition {
        cpsScm {
            scm {
                ...
                lightweight(false)
                scriptPath('jenkinsFiles/Jenkinsfile.IMS_robInternal')
            }
        }
    }
}
