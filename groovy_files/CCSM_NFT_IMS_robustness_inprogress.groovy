pipelineJob('CCSM_NFT_IMS_robustness_inprogress') {
    description('HSS-IMS in progress Non Functional Robustness Test')
    ...
    definition {
        cpsScm {
            scm {
                ...
                lightweight(false)
                scriptPath('jenkinsFiles/Jenkinsfile.IMS_robInProgress')
            }
        }
    }
}
