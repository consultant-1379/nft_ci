pipelineJob('CCSM_NFT_UDM_AUSF_EIR_RELEASE_CLEAR') {
    description('UDM+AUSF+EIR with http-clear release Non Function Test parent job')
    ...
    definition {
        cpsScm {
            scm {
                ...
                lightweight(false)
                scriptPath('jenkinsFiles/Jenkinsfile.UDM_AUSF_EIR_CLEAR_RELEASE')
            }
        }
    }
}
