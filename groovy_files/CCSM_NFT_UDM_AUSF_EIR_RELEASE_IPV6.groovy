pipelineJob('CCSM_NFT_UDM_AUSF_EIR_RELEASE_IPV6') {
    description('UDM+AUSF+EIR with IPv6 release Non Function Test parent job')
    ...
    parameters {
        ...
        booleanParam(ccsm_default_params['run_stability_long']['name'], ccsm_default_params['run_stability_long']['value'].toBoolean(), ccsm_default_params['run_stability_long']['help'])
    ...
    definition {
        cpsScm {
            scm {
                ...
                lightweight(false)
                scriptPath('jenkinsFiles/Jenkinsfile.UDM_AUSF_EIR_IPv6_RELEASE')
            }
        }
    }
}
