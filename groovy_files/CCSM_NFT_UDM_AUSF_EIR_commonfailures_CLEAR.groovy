pipelineJob('CCSM_NFT_UDM_AUSF_EIR_commonfailures_CLEAR') {
    description('UDM+AUSF+EIR with http-clear CommonFailures Test')
    ...
    definition {
        cpsScm {
            scm {
                ...
                lightweight(false)
                scriptPath('jenkinsFiles/Jenkinsfile.UDM_AUSF_EIR_commonfailures')
            }
        }
    }
}
