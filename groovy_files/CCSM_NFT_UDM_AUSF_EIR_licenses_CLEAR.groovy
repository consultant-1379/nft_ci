pipelineJob('CCSM_NFT_UDM_AUSF_EIR_licenses_CLEAR') {
    description('UDM+AUSF+EIR CLEAR Non Functional Licenses Test')
    ...
    parameters {
        ...
        stringParam(ccsm_default_params['licenses_pass_rate']['name'], ccsm_default_params['licenses_pass_rate']['value'], ccsm_default_params['licenses_pass_rate']['help'])
    }
    ...
    definition {
        cpsScm {
            scm {
                ...
                lightweight(false)
                scriptPath('jenkinsFiles/Jenkinsfile.UDM_AUSF_EIR_licenses')
            }
        }
    }
}
