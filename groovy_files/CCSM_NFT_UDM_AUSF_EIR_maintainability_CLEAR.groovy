pipelineJob('CCSM_NFT_UDM_AUSF_EIR_maintainability_CLEAR') {
    description('UDM+AUSF+EIR with http-clear Non Functional Maintainability Test')
    ...
    parameters {
        ...
        stringParam(ccsm_default_params['maintainability_engineering_cap']['name'], ccsm_default_params['maintainability_engineering_cap']['value'], ccsm_default_params['maintainability_engineering_cap']['help'])
        stringParam(ccsm_default_params['maintainability_pass_rate']['name'], ccsm_default_params['maintainability_pass_rate']['value'], ccsm_default_params['maintainability_pass_rate']['help'])
        booleanParam(ccsm_default_params['mtls']['name'], false, ccsm_default_params['mtls']['help'])
    }
    ...
    definition {
        cpsScm {
            scm {
                ...
                lightweight(false)
                scriptPath('jenkinsFiles/Jenkinsfile.UDM_AUSF_EIR_maintainability')
            }
        }
    }
}
