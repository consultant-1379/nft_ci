pipelineJob('CCSM_NFT_UDM_AUSF_EIR_overload_CLEAR') {
    description('UDM+AUSF+EIR with http-clear NFT Overload TCs')
    ...
    definition {
        cpsScm {
            scm {
                ...
                lightweight(false)
                scriptPath('jenkinsFiles/Jenkinsfile.UDM_AUSF_EIR_overload')
            }
        }
    }
}
