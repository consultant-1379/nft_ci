pipelineJob('CCSM_NFT_UDM_AUSF_EIR_overload_INTERNAL') {
    description('UDM+AUSF+EIR internal NFT Overload TCs')
    ...
    definition {
        cpsScm {
            scm {
                ...
                lightweight(false)
                scriptPath('jenkinsFiles/Jenkinsfile.UDM_AUSF_EIR_overloadInternal')
            }
        }
    }
}
