pipelineJob('CCSM_NFT_UDM_AUSF_EIR_overload_daily') {
    description('UDM+AUSF+EIR NFT daily Overload TCs')
    ...
    definition {
        cpsScm {
            scm {
                ...
                lightweight(false)
                scriptPath('jenkinsFiles/Jenkinsfile.UDM_AUSF_EIR_overloadDaily')
            }
        }
    }
}
