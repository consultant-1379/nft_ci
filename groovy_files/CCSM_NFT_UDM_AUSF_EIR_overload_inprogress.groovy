pipelineJob('CCSM_NFT_UDM_AUSF_EIR_overload_inprogress') {
    description('UDM+AUSF+EIR NFT in progress Overload TCs')
    ...
    definition {
        cpsScm {
            scm {
                ...
                lightweight(false)
                scriptPath('jenkinsFiles/Jenkinsfile.UDM_AUSF_EIR_overloadInProgress')
            }
        }
    }
}
