pipelineJob('CCSM_NFT_UDM_AUSF_EIR_robustness_CLEAR') {
    description('UDM+AUSF+EIR with http-clear Non Functional Robustness Test')
    ...
    definition {
        cpsScm {
            scm {
                ...
                lightweight(false)
                scriptPath('jenkinsFiles/Jenkinsfile.UDM_AUSF_EIR_robustness')
            }
        }
    }
}
