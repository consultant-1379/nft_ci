pipelineJob('CCSM_NFT_UDM_AUSF_EIR_robustness_INTERNAL') {
    description('UDM+AUSF+EIR internal Non Functional Robustness Test')
    ...
    definition {
        cpsScm {
            scm {
                ...
                lightweight(false)
                scriptPath('jenkinsFiles/Jenkinsfile.UDM_AUSF_EIR_robInternal')
            }
        }
    }
}
