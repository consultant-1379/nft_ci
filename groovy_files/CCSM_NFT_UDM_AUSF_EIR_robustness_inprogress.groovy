pipelineJob('CCSM_NFT_UDM_AUSF_EIR_robustness_inprogress') {
    description('UDM+AUSF+EIR in progress Non Functional Robustness Test')
    ...
    definition {
        cpsScm {
            scm {
                ...
                lightweight(false)
                scriptPath('jenkinsFiles/Jenkinsfile.UDM_AUSF_EIR_robInProgress')
            }
        }
    }
}
