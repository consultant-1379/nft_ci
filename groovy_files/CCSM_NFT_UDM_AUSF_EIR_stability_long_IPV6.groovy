pipelineJob('CCSM_NFT_UDM_AUSF_EIR_stability_long_IPV6') {
    description('UDM+AUSF+EIR with IPv6 Non Functional Long Stability Test')
    ...
    parameters {
        ...
        stringParam(ccsm_default_params['stability_long_duration']['name'], ccsm_default_params['stability_long_duration']['value'], ccsm_default_params['stability_long_duration']['help'])
    ...
    definition {
        cpsScm {
            scm {
                ...
                lightweight(false)
                scriptPath('jenkinsFiles/Jenkinsfile.UDM_AUSF_EIR_stability')
            }
        }
    }
}
