pipelineJob('CCSM_NFT_UDM_AUSF_EIR_trafficmix_CLEAR') {
    description('UDM+AUSF+EIR with http-clear Non Functional Traffic Mix Test')
    ...
    parameters {
        ...
        stringParam(ccsm_default_params['trafficmix_duration']['name'], ccsm_default_params['trafficmix_duration']['value'], ccsm_default_params['trafficmix_duration']['help'])
    }
    ...
    definition {
        cpsScm {
            scm {
                ...
                lightweight(false)
                scriptPath('jenkinsFiles/Jenkinsfile.UDM_AUSF_EIR_trafficmix')
            }
        }
    }
}
