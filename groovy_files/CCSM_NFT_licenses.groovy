pipelineJob('CCSM_NFT_licenses') {
    description('CCSM Non Functional Licenses Test')
    ...
    parameters {
        ...
        stringParam(ccsm_default_params['robustness_pass_rate']['name'], ccsm_default_params['licenses_pass_rate']['value'], ccsm_default_params['licenses_pass_rate']['help'])
    }
    ...
    definition {
        cpsScm {
            scm {
                ...
                lightweight(false)
                scriptPath('jenkinsFiles/Jenkinsfile.licenses')
            }
        }
    }
}
