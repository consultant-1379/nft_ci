pipelineJob('CCSM_NFT_stability') {
    description('CCSM Non Functional Stability Test')
    ...
    parameters {
        ...
        stringParam(ccsm_default_params['stability_engineering_cap']['name'], '390', ccsm_default_params['stability_engineering_cap']['help'])
        stringParam(ccsm_default_params['stability_pass_rate']['name'], '90', ccsm_default_params['stability_pass_rate']['help'])
    ...
    definition {
        cpsScm {
            scm {
                ...
                lightweight(false)
                scriptPath('jenkinsFiles/Jenkinsfile.stability')
            }
        }
    }
}
